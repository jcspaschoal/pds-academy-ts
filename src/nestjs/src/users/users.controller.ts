...
export class UsersController {
    ...
    @Inject(DeactivateUserUseCase.UseCase)
    private deactivateUserUseCase: DeactivateUserUseCase.UseCase;

    @Inject(CreateAddressUseCase.UseCase)
    private createAddressUseCase: CreateAddressUseCase.UseCase

    @Inject(UpdateAddressUseCase.UseCase)
    private updateAddressUseCase: UpdateAddressUseCase.UseCase

    @Inject(DeleteAddressUseCase.UseCase)
    private deleteAddressUseCase: DeleteAddressUseCase.UseCase
