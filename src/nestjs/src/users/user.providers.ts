...
import {
    ...
    DeleteAddressUseCase, GetAddressUseCase,
    GetUserUseCase,
...
export namespace USER_PROVIDERS {
    ...
    export namespace USER_USE_CASES {
        ...
        export const UPDATE_ADDRESS_USE_CASE = {
            provide: UpdateAddressUseCase.UseCase,
            useFactory: (repository: UserRepository.Repository) => {
                return new UpdateAddressUseCase.UseCase(repository);
            },
            inject: [REPOSITORIES.USER_REPOSITORY.provide],
        };
    }
