...
export type SearchProps<Filter = string> = {
    page?: number; per_page?: number; sort?: string | null; sort_dir?: SortDirection | null; filter?: Filter | null;
};
...
export interface BasicSearchableRepositoryInterface<E extends Entity, Filter = string, SearchInput = SearchParams, SearchOutput = SearchResult<E, Filter>> {
    sortableFields: string[];
    search(props: SearchInput): Promise<SearchOutput>;
}
