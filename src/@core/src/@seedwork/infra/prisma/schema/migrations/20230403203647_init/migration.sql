...
-- CreateTable
CREATE TABLE "GroupHasPermssion" (
    "permission_id" INTEGER NOT NULL,
    "group_id" INTEGER NOT NULL,

    CONSTRAINT "GroupHasPermssion_pkey" PRIMARY KEY ("permission_id","group_id")
);
...
CREATE TABLE "Address" (
    ...
    CONSTRAINT "Address_pkey" PRIMARY KEY ("id_addres")
);
...
-- AddForeignKey
ALTER TABLE "GroupHasPermssion" ADD CONSTRAINT "GroupHasPermssion_permission_id_fkey" FOREIGN KEY ("permission_id") REFERENCES "Permission"("id_permission") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "GroupHasPermssion" ADD CONSTRAINT "GroupHasPermssion_group_id_fkey" FOREIGN KEY ("group_id") REFERENCES "Group"("id_group") ON DELETE RESTRICT ON UPDATE CASCADE;
